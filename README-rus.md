...
[![Doxygen](https://github.com/vortexmethods/VM2D/actions/workflows/docs.yml/badge.svg)](https://github.com/vortexmethods/VM2D/actions/workflows/docs.yml)
...
[Документация пользователя](https://vm2d.readthedocs.io/en/latest), генерируемая средствами [Read the Docs](https://readthedocs.org) находится в процессе разработки, текущая версия доступна по ссылке
...
<tr>  
<td align="center" valign="center" width="160">
<img src="docs/_static/authors/Sukhova.jpg" alt="Сухова Е.Ю."/>
<br />
Сухова
<br />
Екатерина
