...
#pragma omp barrier
	...
	// ≈сли ключ структуры однобайтовый, просто копируем в исходный массив
	if (sizeof(m->key) == 1)
	{
	...
	double cSP, double cRBP, double maxG, double epsCol, int type) 
{
	...
	*/	
	...
	/// ѕоиск границ габаритного пр€моугольника (левый нижний и правый верхний) 
	...
	//дл€ каждого запроса запоминаем индекс iq -- индекс ближайшего левого элемента данных
	//отсортиванный массив mortonCodeBoth раздел€ем на mcquery (только запросы) и mcdata (только данные)
