...
/*!
\file
\brief Сдвиг мультипольных моментов для схемы с order = 15
                ...
                for (i = 0; i < 2; i++)
                {
                    ...
                    if (chd >= nbodiesd)
                    {
                         ...
                         if (objectType == 0)
                         {
                              ...
                              mom1 = mom2 = mom3 = mom4 = mom5 = mom6 = mom7 = mom8 = mom9 = mom10 = mom11 = mom12 = mom13 = mom14 = real2{ 0, 0 };
                         ...
                         if ((objectType == 1) || (objectType == 2) || (objectType == -1) || (objectType == -2))
                         {
                              ...
                              mom1 = mom3 = mom5 = mom7 = mom9 = mom11 = mom13 = real2{ 0, 0 };
