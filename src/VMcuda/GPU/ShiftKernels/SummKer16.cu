            ...
            if (j == 0) {
                ...
                for (i = 0; i < 2; i++)
                {
                    ...
                    else
                    {
                     ...
                     momh15 += 455 * multz(mom3, z);

                     z = multz(z, dr);

                     momh13 += multz(mom0, z);
                     momh14 += 14 * multz(mom1, z);
                     momh15 += 105 * multz(mom2, z);
