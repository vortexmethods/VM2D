...
/*!
\file
\brief Сдвиг мультипольных моментов для схемы с order = 14
                ...
                for (i = 0; i < 2; i++)
                {
                    ...
                    if (chd >= nbodiesd)
                    {
                         ...
                         if (objectType == 0)
                         {
                              ...
                              mom1 = mom2 = mom3 = mom4 = mom5 = mom6 = mom7 = mom8 = mom9 = mom10 = mom11 = mom12 = mom13 = real2{ 0, 0 };
