...
class bvh
{
  ...
  public:
    ...
    bvh(const thrust::device_vector<object_type>& objects_d)
        : objects_d_(objects_d), query_host_enabled_(false)
    {
        this->construct();
    }
    ...
    void construct()
    {
        ...
        const unsigned int num_objects        = (int)objects_d_.size();
        ...
        thrust::for_each(thrust::device,
            ...
            [self, flags] __device__ __host__ (index_type idx)
            {
#ifdef __CUDA_ARCH__    
