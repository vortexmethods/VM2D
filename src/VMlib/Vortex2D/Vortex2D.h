...
namespace VMlib
{
	...
	*/
	...
	public:
		...
		/// \brief Функция для доступа к радиусу вихря
		/// \return ссылка на радиус вихря
		HD double& sigma() { return sgm; }

		/// \brief Функция для доступа для чтения к радиусу вихря
		/// \return константная ссылка на радиус вихря
		HD const double& sigma() const { return sgm; }
